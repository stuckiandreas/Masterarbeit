//-----------------------------------------------------------------------
// <copyright file="TestCollectionResultAndValveHardware.cs" company="VAT Vakuumventile AG">
...
namespace ETIC2.Model.Application.FirmwareView
{
    ...
    /// </summary>
    public class TestCollectionResultAndValveHardware
    {
        ...
        public TestCollectionResultAndValveHardware()
        {
        }
    }
}
