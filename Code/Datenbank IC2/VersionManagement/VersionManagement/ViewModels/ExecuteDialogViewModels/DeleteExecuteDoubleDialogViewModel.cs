...
namespace VersionManagement.ViewModels.ExecuteDialogViewModels
{
    ...
    public class DeleteExecuteDoubleDialogViewModel : DeleteExecuteDialogViewModel
    {
        ...
        {
            if (this.versionManagementModel.SelectionItemDatabaseManager.DeletePropertType(TextInputViewModelSelectedItem.TextInput, this.TextInputViewModelDescription.TextInput) == false)
