...
-Test: Ein Beispieltest, um zu zeigen, was im C-Code bearbeitet wurde
-TestUpdateFirmware: Aktualisierung der Testinformationen (Auszug C-Code, welcher bearbeitet wurde)
